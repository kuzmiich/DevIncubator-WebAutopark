...
namespace Dapper.Specification.Provider.Extensions
{
    public static class PropertyInfoExtension
    {
        ...
        public static string EnumerableJoin(this IEnumerable<PropertyInfo> properties, char start, char end) =>
        ...
        public static string EnumerableJoin(this IEnumerable<PropertyInfo> properties, char separator) =>
        ...
        public static string EnumerableJoin(this IEnumerable<PropertyInfo> properties) =>
